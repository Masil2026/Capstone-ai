...
async def test_classification_itinerary_new():
    ...
    result: ResponseClassification = r.data
...
async def test_classification_boundary_place_vs_date():
    ...
    _print_result("boundary_place", r_place.data)
    _print_result("boundary_date", r_date.data)
    assert r_place.data.type == "itinerary"
    assert r_date.data.type == "change"
