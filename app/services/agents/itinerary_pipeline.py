...
def _build_synthesizer_prompt(d: SynthesizerDeps) -> str:
    ...
    lines = [
        ...
        "   예) '2026-12-20': [{\"plan_name\":\"숙소→ICN 이동\",\"time\":\"09:00~11:00\",...}, {\"plan_name\":\"ICN→STN 항공 이동 (XX항공)\",\"time\":\"11:30~24:00\",\"cost\":{\"amount\":850,\"currency\":\"GBP\",\"amount_krw\":1500000},...}]",
    ...
    lines += [
        ...
        "   예) 잘못된 순서: [항공이동(20:07~24:00), 공항이동(18:30~19:30)] → 올바른 순서: [공항이동(18:30~19:30), 항공이동(20:07~24:00)]",
        ...
        "   다음날 도착: 출발일 time='출발지현지시각 ~ 24:00'  예) '20:07 ~ 24:00'",
        ...
        "⚠️ 24:00은 하루의 끝(자정)을 표기할 때만 사용. 다음 날 시작은 반드시 00:00 사용.",
        "   예) 전날 항공: time='20:07 ~ 24:00' / 다음날 기내 연속: time='00:00 ~ 21:22'",
        "⚠️ 항공 외 일반 일정은 자정을 넘으면 별도 항목 분리.",
        "올바른 예) '09:00 ~ 10:30', '20:07 ~ 24:00', '00:00 ~ 21:22', '23:30 ~ 24:00', '00:00 ~ 02:15'",
        "",
        "## 식사 배치 규칙",
